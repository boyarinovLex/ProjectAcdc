...
public class Container {
    ...
    public static final QuestService questService = new QuestService(questRepository, answersRepository, uploadQuests);
    public static final AnswerService answerService = new AnswerService(answersRepository);
    public static final GameService gameService = new GameService(answerService);
}
